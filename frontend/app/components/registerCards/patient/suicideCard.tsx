...
export default function SuicideCard({ pageNumber }: { pageNumber: number }) {
  const [suicide, setSuicide] = useState<string | null>(null);

  return (
    <Card className="w-xl max-w-screen border-none pl-8 pr-4">
      <CardHeader className="relative">
        <CardTitle className="font-medium text-xl sm:text-2xl">
          Hast du aktuelle Suizidgedanken oder Absichten?
        </CardTitle>
